...
.field lifecycle:Landroidx/lifecycle/r;
...
.method public constructor <init>(ZLjava/util/List;IZ)V
    ...
    .line 42
    .line 43
    iget-object p1, p1, Landroidx/lifecycle/P;->h:Landroidx/lifecycle/z;

    .line 44
    .line 45
    iput-object p1, p0, Lcom/tiktok/appevents/TTAppEventLogger;->lifecycle:Landroidx/lifecycle/r;
    ...
    .line 65
    .line 66
    iget-object p2, p0, Lcom/tiktok/appevents/TTAppEventLogger;->lifecycle:Landroidx/lifecycle/r;

    .line 67
    .line 68
    invoke-virtual {p2, p1}, Landroidx/lifecycle/r;->a(Landroidx/lifecycle/w;)V
...
.method private doStartScheduler(IZ)V
    ...
    .line 39
    invoke-direct {v1, p0, p1, p2}, LE6/c;-><init>(Ljava/lang/Object;II)V
...
.method private trackEvent(Lcom/tiktok/appevents/TTAppEvent$TTAppEventType;Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;)V
    ...
    .line 36
    invoke-direct/range {v0 .. v6}, LR/n;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public flush(Lcom/tiktok/appevents/TTAppEventLogger$FlushReason;)V
    ...
    .line 8
    .line 9
    invoke-static {v4}, Lcom/tiktok/util/TTUtil;->checkThread(Ljava/lang/String;)V
    ...
    .line 57
    .line 58
    const-string v7, "Start flush, version %d reason is %s"
    ...
    .line 75
    .line 76
    invoke-virtual {v6, v7, v10}, Lcom/tiktok/util/TTLogger;->debug(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 87
    invoke-virtual {v6, v7}, Lcom/tiktok/appevents/TTAppEventPersist;->addEvents(Ljava/util/List;)V

    .line 88
    .line 89
    .line 90
    invoke-virtual {v6}, Lcom/tiktok/appevents/TTAppEventPersist;->getAppEvents()Ljava/util/List;
    ...
    .line 106
    invoke-static {v8, v6}, Lcom/tiktok/appevents/TTRequest;->reportAppEvent(Lorg/json/JSONObject;Ljava/util/List;)Ljava/util/List;
    ...
    .line 134
    .line 135
    invoke-static {v6}, Lcom/tiktok/appevents/TTAppEventStorage;->persist(Ljava/util/List;)V
    ...
    .line 160
    .line 161
    invoke-virtual {v6, v8, v11}, Lcom/tiktok/util/TTLogger;->debug(Ljava/lang/String;[Ljava/lang/Object;)V

    .line 162
    .line 163
    .line 164
    iget v5, p0, Lcom/tiktok/appevents/TTAppEventLogger;->flushId:I
    ...
    .line 167
    iput v5, p0, Lcom/tiktok/appevents/TTAppEventLogger;->flushId:I
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    ...
    .line 175
    .line 176
    const-string v7, "SDK can\'t send tracking events to server, it will be cached locally, and will be sent in batches only after startTracking"
    ...
    .line 187
    :goto_1
    sget-object v6, Lcom/tiktok/appevents/TTAppEventLogger;->TAG:Ljava/lang/String;

    .line 188
    .line 189
    invoke-static {v6, v5, v0}, Lcom/tiktok/appevents/TTCrashHandler;->handleCrash(Ljava/lang/String;Ljava/lang/Throwable;I)V
    ...
    .line 225
    .line 226
    sget v2, Lcom/tiktok/appevents/TTAppEventLogger;->TIME_BUFFER:I
    ...
    .line 239
    .line 240
    invoke-virtual {p0, v0, p1, v4}, Lcom/tiktok/appevents/TTAppEventLogger;->monitorMetric(Ljava/lang/String;Lorg/json/JSONObject;Lorg/json/JSONObject;)V
    :try_end_3
    ...
    .line 244
    .line 245
    invoke-direct {p1, v1}, Lcom/tiktok/appevents/a;-><init>(I)V
...
.method public initConfig(JLcom/tiktok/TikTokBusinessSdk$TTInitCallback;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    ...
    .line 22
    .line 23
    invoke-direct {v0, p3, v1, p4}, Landroidx/camera/core/impl/Y;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public monitorMetric(Ljava/lang/String;Lorg/json/JSONObject;Lorg/json/JSONObject;)V
    ...
    .line 9
    .line 10
    invoke-direct {v0, p1, v1, p2, p3}, LH1/l;-><init>(Ljava/lang/Object;ILjava/lang/Object;Ljava/lang/Object;)V
